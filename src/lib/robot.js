import { chat } from "./conversazione.js";

const bot = function () {
    //componenti di aggancio all'html
    ...
    //probabilmente roba per lo stle e per scrollar nell'html
    ...
    const insertNewChatItem = function (elem) {
        ...
        //appende a pekobtd div leme
        peekobot.appendChild(elem);
        scrollContainer();
        //debugger;
        //no idea dice debugger
        elem.classList.add('activated');
    };

    //funzioe ricorsiva che stampa la rispista
    const printResponse = async function (step) {
        //crea div class "chat-response"
        const response = document.createElement('div');
        response.classList.add('chat-response');
        response.innerHTML = step.text;
        //----
        //classe mia
        const custum_js = document.createElement('div');
        custum_js.classList.add('chat-response');
        let custumtxt = document.createTextNode("TESTOPTROVA");
        custum_js.appendChild(custumtxt);
        custum_js.innerHTML = step.js;
